            ...
            children: [
              ...
              Stack(
                children: const [
                  Image(
                    image: AssetImage(
                        'assets/images/drought_background_child_pic.png'),
                  ),
                  Text(
                    '1. Loss of fluid in the body as a result of diarrhea or vomiting.\n2.Insufficient breast milk for not drinking enough water.\n3. High air temperature.',
                    style: TextStyle(
                      fontSize: 25,
                      fontWeight: FontWeight.bold,
                      color: Color(0xFF204D66),
              ...
              Row(
                ...
                children: const [
                  ...
                  Expanded(
                    child: Image(
                      image:
                          AssetImage('assets/images/drought_child_pic.png.png'),
                    ),
                  ),
                ],
              ),
